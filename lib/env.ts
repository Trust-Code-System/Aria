...
export const env = {
  ...
  composioGoogleSheetsAuthConfigId: str(process.env.COMPOSIO_GOOGLE_SHEETS_AUTH_CONFIG_ID),
  composioGoogleDocsAuthConfigId: str(process.env.COMPOSIO_GOOGLE_DOCS_AUTH_CONFIG_ID),
  composioDropboxAuthConfigId: str(process.env.COMPOSIO_DROPBOX_AUTH_CONFIG_ID),
  composioAirtableAuthConfigId: str(process.env.COMPOSIO_AIRTABLE_AUTH_CONFIG_ID),
  composioTodoistAuthConfigId: str(process.env.COMPOSIO_TODOIST_AUTH_CONFIG_ID),
  composioDiscordAuthConfigId: str(process.env.COMPOSIO_DISCORD_AUTH_CONFIG_ID),
  composioTwitterAuthConfigId: str(process.env.COMPOSIO_TWITTER_AUTH_CONFIG_ID),
  composioWhatsappAuthConfigId: str(process.env.COMPOSIO_WHATSAPP_AUTH_CONFIG_ID),
  composioTelegramAuthConfigId: str(process.env.COMPOSIO_TELEGRAM_AUTH_CONFIG_ID),
